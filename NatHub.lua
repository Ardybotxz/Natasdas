...
if premium then
    supportedGames = {
        ...
        [5750914919] = "https://api.luarmor.net/files/v4/loaders/bfd8ac56165c2caf1eebc5a14ccdb134.lua", -- Fisch
        ...
        [6331902150] = "https://api.luarmor.net/files/v4/loaders/0771107275ffabca9221c264306214f9.lua" -- Forsaken
    }
    scriptID = {
    ...
    supportedGames = {
        ...
        [5750914919] = "https://api.luarmor.net/files/v4/loaders/8782b4febedc346da2f704fa97d11601.lua", -- Fisch
    ...
    scriptID = {
        ...
        [5750914919] = "8782b4febedc346da2f704fa97d11601", -- Fisch
